...
1. The core features of Node.js and Express and why they are useful.
  => Node.js executes javscript outside of the browser and Express framework is for routing
2. Understand and explain the use of Middleware.
  => middleware is a function that intercept and run a piece of code beyond the Express framework
3. The basic principles of the REST architectural style.
  => a- resource. b- unique URL. c- representations. d- stateless protocol. e- http methods
4. Understand and explain the use of Express Routers.
  => Express router use differnt request handlers
